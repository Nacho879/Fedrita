...
import { PlusCircle, Edit3, Trash2, User, Briefcase, Clock, Users, Home, Crown } from 'lucide-react';
      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className="mb-4 md:mb-0 text-center md:text-left">
            ...
            <p className="text-gray-600 text-lg">Gestiona el equipo de {managedSalon.name}.</p>
          </div>
        ...
        {employees.length === 0 && !loadingEmployees && (
          ...
          >
            ...
            <h2 className="text-2xl font-semibold text-gray-700 mb-3">Aún no hay empleados en este salón</h2>
            ...
            <Button onClick={() => navigate('/crear-empleado')} className="gradient-bg hover:opacity-90 text-lg px-8 py-3">
              <PlusCircle className="mr-2 h-5 w-5" /> Añadir Primer Empleado
            </Button>
          </motion.div>
        )}
            ...
            >
              <Card className="shadow-xl hover:shadow-2xl transition-shadow duration-300 border-0 overflow-hidden flex flex-col h-full">
                ...
                <CardContent className="p-6 space-y-3 flex-grow">
                  ...
                  {!employee.availability && (
                    <p className="text-gray-500 italic">No hay horarios especificados.</p>
                  )}
                </CardContent>
